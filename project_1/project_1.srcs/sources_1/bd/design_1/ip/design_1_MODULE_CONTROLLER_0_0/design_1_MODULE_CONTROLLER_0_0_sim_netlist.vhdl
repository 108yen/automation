...
architecture STRUCTURE of design_1_MODULE_CONTROLLER_0_0_ACK_DETECTOR is
  ...
  attribute SOFT_HLUTNM of ACK_TRIGER_i_2 : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \df_l[2]_i_10\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \df_l[2]_i_11\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \df_l[2]_i_12\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \df_l[2]_i_7\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \df_l[2]_i_8\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \df_l[2]_i_9\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \dlc[1]_i_1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \dlc[2]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \dlc[3]_i_1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \dlc[3]_i_2\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \msg_bit[0]_i_1\ : label is "soft_lutpair7";
  ...
  attribute SOFT_HLUTNM of \msg_bit[7]_i_1\ : label is "soft_lutpair6";
...
\df_l[2]_i_11\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"F69FFFFF"
    )
        port map (
...
\df_l[2]_i_12\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
...
\df_l[2]_i_13\: unisim.vcomponents.LUT6
    generic map(
...
architecture STRUCTURE of design_1_MODULE_CONTROLLER_0_0_ACK_JUDGE is
  ...
  attribute SOFT_HLUTNM of \counter[4]_i_1__0\ : label is "soft_lutpair36";
...
entity design_1_MODULE_CONTROLLER_0_0_ATTACK_SIGNAL_GENERATOR is
  port (
    ...
    attack_bit_reg_1 : out STD_LOGIC;
    \resyn_count_reg[2]_0\ : out STD_LOGIC;
    TO_RECESSIVE_i_4_0 : out STD_LOGIC;
    ...
    resyn_i_4_0 : in STD_LOGIC_VECTOR ( 0 to 0 );
    resyn_i_3_0 : in STD_LOGIC_VECTOR ( 0 to 0 );
    ...
    resyn_bit_inferred_i_4 : in STD_LOGIC_VECTOR ( 1 downto 0 );
...
architecture STRUCTURE of design_1_MODULE_CONTROLLER_0_0_ATTACK_SIGNAL_GENERATOR is
  ...
  signal \receiver_count__0\ : STD_LOGIC_VECTOR ( 7 downto 0 );
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of TO_RECESSIVE_i_6 : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of TO_RECESSIVE_i_7 : label is "soft_lutpair18";
  ...
  attribute SOFT_HLUTNM of ex_count_i_5 : label is "soft_lutpair15";
...
TO_RECESSIVE_i_6: unisim.vcomponents.LUT3
    generic map(
      INIT => X"BE"
    )
        port map (
...
receiver_count_carry: unisim.vcomponents.CARRY4
     port map (
      ...
      DI(0) => Q(0),
      O(3 downto 0) => \receiver_count__0\(3 downto 0),
...
\receiver_count_carry__0\: unisim.vcomponents.CARRY4
     port map (
      ...
      O(3 downto 0) => \receiver_count__0\(7 downto 4),
      S(3) => resyn_i_3_0(0),
...
resyn_bit_inferred_i_7: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
        ...
        port map (
      I0 => \^attack_bit\,
      I1 => resyn_bit_inferred_i_4(0),
      I2 => resyn_bit_inferred_i_4(1),
      I3 => \^attacked_reg_0\,
      O => attack_bit_reg_1
    );
...
resyn_i_3: unisim.vcomponents.LUT3
    generic map(
      INIT => X"04"
    )
        port map (
      I0 => \receiver_count__0\(4),
      I1 => \receiver_count__0\(3),
      I2 => \receiver_count__0\(1),
      O => resyn_i_3_n_0
    );
resyn_i_4: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFFFEFFFFFFFFFF"
        ...
        port map (
      I0 => \receiver_count__0\(6),
      I1 => \receiver_count__0\(2),
      I2 => \receiver_count__0\(7),
      I3 => \^attack_bit\,
      I4 => \receiver_count__0\(0),
      I5 => \receiver_count__0\(5),
      O => resyn_i_4_n_0
    );
...
resyn_i_7: unisim.vcomponents.LUT6
    generic map(
...
architecture STRUCTURE of design_1_MODULE_CONTROLLER_0_0_BIT_COUNT is
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of DEBUG_1_i_5 : label is "soft_lutpair26";
  attribute SOFT_HLUTNM of DEBUG_2_i_4 : label is "soft_lutpair25";
  ...
  attribute SOFT_HLUTNM of \RECEIVER_BIT[3]_i_1\ : label is "soft_lutpair22";
  attribute SOFT_HLUTNM of \RECEIVER_BIT[4]_i_1\ : label is "soft_lutpair22";
  attribute SOFT_HLUTNM of \RECEIVER_BIT[6]_i_2\ : label is "soft_lutpair30";
  attribute SOFT_HLUTNM of \RECEIVER_BIT[7]_i_2\ : label is "soft_lutpair26";
  attribute SOFT_HLUTNM of \SENDER_BIT[0]_i_1\ : label is "soft_lutpair34";
  attribute SOFT_HLUTNM of \SENDER_BIT[1]_i_1\ : label is "soft_lutpair34";
  attribute SOFT_HLUTNM of \SENDER_BIT[2]_i_1\ : label is "soft_lutpair29";
  attribute SOFT_HLUTNM of \SENDER_BIT[3]_i_1\ : label is "soft_lutpair23";
  attribute SOFT_HLUTNM of \SENDER_BIT[4]_i_1\ : label is "soft_lutpair23";
  attribute SOFT_HLUTNM of \SENDER_BIT[6]_i_2\ : label is "soft_lutpair29";
  attribute SOFT_HLUTNM of \SENDER_BIT[7]_i_2\ : label is "soft_lutpair25";
  attribute SOFT_HLUTNM of TO_DOMINANT_i_8 : label is "soft_lutpair32";
  attribute SOFT_HLUTNM of TO_RECESSIVE_i_9 : label is "soft_lutpair32";
  ...
  attribute SOFT_HLUTNM of \count[7]_i_2\ : label is "soft_lutpair27";
  attribute SOFT_HLUTNM of \count[7]_i_3\ : label is "soft_lutpair28";
  attribute SOFT_HLUTNM of s_bit_inc_i_4 : label is "soft_lutpair27";
begin
...
TO_RECESSIVE_i_9: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
architecture STRUCTURE of design_1_MODULE_CONTROLLER_0_0_MSG_FILTER is
  ...
  attribute SOFT_HLUTNM of \resyn_edge[1]_i_1\ : label is "soft_lutpair88";
begin
...
architecture STRUCTURE of design_1_MODULE_CONTROLLER_0_0_STATE_DETECTOR is
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of DEBUG_1_i_1 : label is "soft_lutpair89";
  attribute SOFT_HLUTNM of STATE_i_1 : label is "soft_lutpair89";
  attribute SOFT_HLUTNM of \can_signal_reg[0]_i_1\ : label is "soft_lutpair90";
  attribute SOFT_HLUTNM of \can_signal_reg[1]_i_1\ : label is "soft_lutpair90";
begin
  clear <= \^clear\;
  state <= \^state\;
...
architecture STRUCTURE of design_1_MODULE_CONTROLLER_0_0_SUCCESS_PROBABILITY is
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \count[15]_i_1\ : label is "soft_lutpair44";
  attribute SOFT_HLUTNM of search_i_1 : label is "soft_lutpair45";
  attribute SOFT_HLUTNM of \success_rate_reg[13]_i_1\ : label is "soft_lutpair44";
...
entity design_1_MODULE_CONTROLLER_0_0_TQ_OBSERVER is
  port (
    ...
    SR : in STD_LOGIC_VECTOR ( 0 to 0 );
    CAN_SIGNAL_IN : in STD_LOGIC;
    \S_COUNTER_reg[6]_0\ : in STD_LOGIC;
    RESET : in STD_LOGIC;
    ...
    \R_COUNTER_reg[3]_0\ : in STD_LOGIC;
    r_bit_inc_reg_1 : in STD_LOGIC;
...
architecture STRUCTURE of design_1_MODULE_CONTROLLER_0_0_TQ_OBSERVER is
  ...
  signal \S_COUNTER[6]_i_2_n_0\ : STD_LOGIC;
  signal \S_COUNTER[6]_i_3_n_0\ : STD_LOGIC;
  signal \S_COUNTER[6]_i_4_n_0\ : STD_LOGIC;
  signal \S_COUNTER[7]_i_1_n_0\ : STD_LOGIC;
  signal \S_COUNTER[7]_i_2_n_0\ : STD_LOGIC;
  signal \S_COUNTER[7]_i_3_n_0\ : STD_LOGIC;
  signal \S_COUNTER[7]_i_4_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \RECEIVER_BIT[7]_i_3\ : label is "soft_lutpair94";
  attribute SOFT_HLUTNM of \RECEIVER_TQ[7]_i_10\ : label is "soft_lutpair97";
  attribute SOFT_HLUTNM of \RECEIVER_TQ[7]_i_9\ : label is "soft_lutpair97";
  attribute SOFT_HLUTNM of \R_COUNTER[1]_i_3\ : label is "soft_lutpair96";
  attribute SOFT_HLUTNM of \R_COUNTER[2]_i_2\ : label is "soft_lutpair99";
  attribute SOFT_HLUTNM of \R_COUNTER[3]_i_1\ : label is "soft_lutpair99";
  ...
  attribute SOFT_HLUTNM of \R_COUNTER[7]_i_5\ : label is "soft_lutpair102";
  attribute SOFT_HLUTNM of \R_COUNTER[7]_i_6\ : label is "soft_lutpair102";
  attribute SOFT_HLUTNM of \SENDER_TQ[7]_i_11\ : label is "soft_lutpair93";
  attribute SOFT_HLUTNM of \SENDER_TQ[7]_i_5\ : label is "soft_lutpair98";
  attribute SOFT_HLUTNM of SP_TRG_i_2 : label is "soft_lutpair95";
  attribute SOFT_HLUTNM of SP_TRG_i_3 : label is "soft_lutpair92";
  attribute SOFT_HLUTNM of \S_COUNTER[2]_i_1\ : label is "soft_lutpair91";
  attribute SOFT_HLUTNM of \S_COUNTER[3]_i_1\ : label is "soft_lutpair91";
  attribute SOFT_HLUTNM of \S_COUNTER[5]_i_1\ : label is "soft_lutpair101";
  attribute SOFT_HLUTNM of \S_COUNTER[6]_i_2\ : label is "soft_lutpair101";
  attribute SOFT_HLUTNM of \S_COUNTER[6]_i_3\ : label is "soft_lutpair92";
  attribute SOFT_HLUTNM of TO_DOMINANT_i_6 : label is "soft_lutpair95";
  attribute SOFT_HLUTNM of attack_bit_i_6 : label is "soft_lutpair94";
  attribute SOFT_HLUTNM of ex_count_i_3 : label is "soft_lutpair98";
  attribute SOFT_HLUTNM of resyn_bit_inferred_i_5 : label is "soft_lutpair93";
begin
...
\RECEIVER_TQ[7]_i_4\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"0000FF0FF800F800"
    )
        port map (
      I0 => \R_COUNTER[1]_i_2_n_0\,
      I1 => \^q\(0),
      I2 => \R_COUNTER[7]_i_3_n_0\,
      I3 => \RECEIVER_TQ[7]_i_9_n_0\,
      I4 => \RECEIVER_TQ[7]_i_10_n_0\,
      I5 => \S_COUNTER[7]_i_4_n_0\,
...
\RECEIVER_TQ_reg[3]_i_1\: unisim.vcomponents.CARRY4
     port map (
      ...
      CYINIT => '0',
      DI(3) => \S_COUNTER[7]_i_4_n_0\,
      DI(2) => \S_COUNTER[7]_i_4_n_0\,
...
\RECEIVER_TQ_reg[7]_i_3\: unisim.vcomponents.CARRY4
     port map (
      ...
      DI(3) => '0',
      DI(2) => \S_COUNTER[7]_i_4_n_0\,
      DI(1) => \S_COUNTER[7]_i_4_n_0\,
      DI(0) => \S_COUNTER[7]_i_4_n_0\,
...
\R_COUNTER[7]_i_3\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"0002000200000002"
        ...
        port map (
      I0 => \R_COUNTER_reg[3]_0\,
      I1 => \SENDER_TQ_reg[0]_2\,
...
\R_COUNTER[7]_i_6\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"7F"
    )
        port map (
...
\SENDER_TQ[7]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I4 => \in\(1),
      I5 => \SENDER_TQ[7]_i_9_n_0\,
      O => \SENDER_TQ[7]_i_1_n_0\
    );
\SENDER_TQ[7]_i_11\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFF33337"
    )
        port map (
...
\SENDER_TQ[7]_i_6\: unisim.vcomponents.LUT6
    generic map(
      ...
      I1 => sender_TQ(0),
      I2 => sender_TQ(3),
      I3 => \SENDER_TQ_reg[0]_2\,
      I4 => \SENDER_TQ_reg[0]_1\,
      I5 => \SENDER_TQ[7]_i_16_n_0\,
      O => \in\(4)
    );
...
\SENDER_TQ_reg[3]_i_1\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3) => \SENDER_TQ[3]_i_2_n_0\,
      S(2) => \SENDER_TQ[3]_i_3_n_0\,
      S(1) => \SENDER_TQ[3]_i_4_n_0\,
      S(0) => \SENDER_TQ[3]_i_5_n_0\
    );
...
\S_COUNTER[0]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"888A8888"
        ...
        port map (
      I0 => RESET,
      I1 => \S_COUNTER_reg[6]_0\,
      I2 => \S_COUNTER[7]_i_4_n_0\,
      I3 => s_counter(0),
...
\S_COUNTER[5]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"41"
        ...
        port map (
      I0 => \S_COUNTER[1]_i_3_n_0\,
      I1 => \S_COUNTER[5]_i_2_n_0\,
      I2 => s_counter(5),
      O => \S_COUNTER[5]_i_1_n_0\
    );
\S_COUNTER[5]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"7FFFFFFF"
    )
        port map (
...
\S_COUNTER[6]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFEF"
    )
        port map (
      ...
      I1 => \S_COUNTER_reg[6]_0\,
      I2 => RESET,
      I3 => \S_COUNTER[7]_i_4_n_0\,
      O => \S_COUNTER[6]_i_1_n_0\
    );
\S_COUNTER[6]_i_2\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"41"
    )
        port map (
      ...
      I2 => s_counter(6),
      O => \S_COUNTER[6]_i_2_n_0\
    );
\S_COUNTER[6]_i_3\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00000008"
    )
        port map (
      ...
      I3 => s_counter(1),
      I4 => s_counter(0),
      O => \S_COUNTER[6]_i_3_n_0\
    );
\S_COUNTER[6]_i_4\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0001"
    )
        port map (
      ...
      I2 => s_counter(6),
      I3 => s_counter(7),
      O => \S_COUNTER[6]_i_4_n_0\
    );
\S_COUNTER[7]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"0000000000008828"
    )
        port map (
...
\S_COUNTER[7]_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
      I0 => \S_COUNTER[1]_i_3_n_0\,
      I1 => \S_COUNTER[6]_i_3_n_0\,
...
\S_COUNTER[7]_i_4\: unisim.vcomponents.LUT6
    generic map(
...
s_bit_inc_i_1: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
      I0 => s_bit_inc_i_2_n_0,
      I1 => r_bit_inc,
      O => \SENDER_TQ_reg[0]_0\
    );
s_bit_inc_i_2: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFFFFFBFFF33333"
    )
        port map (
      I0 => sender_TQ(0),
      I1 => SP_TRG_i_2_n_0,
...
\SENDER_TQ[7]_i_10\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"DF"
    )
        port map (
...
\S_COUNTER[7]_i_5\: unisim.vcomponents.LUT6
    generic map(
...
architecture STRUCTURE of design_1_MODULE_CONTROLLER_0_0_DEVIATION_CORRECTOR is
  ...
  attribute SOFT_HLUTNM of \SEARCH_NUM[31]_i_4\ : label is "soft_lutpair66";
  ...
  attribute SOFT_HLUTNM of \array[0][3]_i_10\ : label is "soft_lutpair72";
  attribute SOFT_HLUTNM of \array[0][3]_i_11\ : label is "soft_lutpair67";
  attribute SOFT_HLUTNM of \array[0][3]_i_2\ : label is "soft_lutpair61";
  attribute SOFT_HLUTNM of \array[0][3]_i_5\ : label is "soft_lutpair87";
  attribute SOFT_HLUTNM of \array[0][3]_i_8\ : label is "soft_lutpair75";
  attribute SOFT_HLUTNM of \array[0][3]_i_9\ : label is "soft_lutpair74";
  attribute SOFT_HLUTNM of \array[0][4]_i_1\ : label is "soft_lutpair61";
  attribute SOFT_HLUTNM of \array[0][6]_i_1\ : label is "soft_lutpair84";
  attribute SOFT_HLUTNM of \array[0][7]_i_1\ : label is "soft_lutpair84";
  ...
  attribute SOFT_HLUTNM of \array[1][3]_i_6\ : label is "soft_lutpair69";
  attribute SOFT_HLUTNM of \array[1][4]_i_1\ : label is "soft_lutpair52";
  attribute SOFT_HLUTNM of \array[1][6]_i_1\ : label is "soft_lutpair81";
  attribute SOFT_HLUTNM of \array[1][7]_i_1\ : label is "soft_lutpair81";
  ...
  attribute SOFT_HLUTNM of \array[4][1]_i_1\ : label is "soft_lutpair74";
  attribute SOFT_HLUTNM of \array[4][2]_i_1\ : label is "soft_lutpair64";
  ...
  attribute SOFT_HLUTNM of \array[4][6]_i_1\ : label is "soft_lutpair65";
  attribute SOFT_HLUTNM of \array[4][7]_i_1\ : label is "soft_lutpair65";
  attribute SOFT_HLUTNM of \array[4][7]_i_2\ : label is "soft_lutpair49";
  attribute SOFT_HLUTNM of \array[5][0]_i_1\ : label is "soft_lutpair87";
  attribute SOFT_HLUTNM of \array[5][1]_i_1\ : label is "soft_lutpair69";
  attribute SOFT_HLUTNM of \array[5][2]_i_1\ : label is "soft_lutpair62";
  ...
  attribute SOFT_HLUTNM of \array[5][6]_i_1\ : label is "soft_lutpair63";
  attribute SOFT_HLUTNM of \array[5][7]_i_1\ : label is "soft_lutpair63";
  ...
  attribute SOFT_HLUTNM of \array[6][2]_i_1\ : label is "soft_lutpair59";
  attribute SOFT_HLUTNM of \array[6][3]_i_2\ : label is "soft_lutpair47";
  attribute SOFT_HLUTNM of \array[6][3]_i_4\ : label is "soft_lutpair68";
  attribute SOFT_HLUTNM of \array[6][4]_i_1\ : label is "soft_lutpair59";
  attribute SOFT_HLUTNM of \array[6][6]_i_1\ : label is "soft_lutpair56";
  attribute SOFT_HLUTNM of \array[6][7]_i_1\ : label is "soft_lutpair56";
  attribute SOFT_HLUTNM of \array[6][7]_i_2\ : label is "soft_lutpair47";
  attribute SOFT_HLUTNM of \array[7][0]_i_1\ : label is "soft_lutpair68";
  attribute SOFT_HLUTNM of \array[7][1]_i_1\ : label is "soft_lutpair58";
  attribute SOFT_HLUTNM of \array[7][2]_i_1\ : label is "soft_lutpair46";
  attribute SOFT_HLUTNM of \array[7][3]_i_1\ : label is "soft_lutpair46";
  attribute SOFT_HLUTNM of \array[7][4]_i_1\ : label is "soft_lutpair58";
  attribute SOFT_HLUTNM of \array[7][6]_i_1\ : label is "soft_lutpair82";
  attribute SOFT_HLUTNM of \array[7][7]_i_1\ : label is "soft_lutpair82";
  attribute SOFT_HLUTNM of \continuous[0]_i_1\ : label is "soft_lutpair80";
  attribute SOFT_HLUTNM of \continuous[1]_i_1\ : label is "soft_lutpair66";
  ...
  attribute SOFT_HLUTNM of \continuous[4]_i_1\ : label is "soft_lutpair48";
  attribute SOFT_HLUTNM of \continuous[5]_i_1\ : label is "soft_lutpair80";
  attribute SOFT_HLUTNM of \continuous[6]_i_1\ : label is "soft_lutpair73";
  attribute SOFT_HLUTNM of \continuous[7]_i_2\ : label is "soft_lutpair73";
  attribute SOFT_HLUTNM of \continuous[7]_i_3\ : label is "soft_lutpair48";
...
attack_signal_generator: entity work.design_1_MODULE_CONTROLLER_0_0_ATTACK_SIGNAL_GENERATOR
     port map (
      ...
      RESET => RESET,
      S(2) => tq_observer_n_28,
      S(1) => tq_observer_n_29,
      S(0) => tq_observer_n_30,
      SR(0) => attack_signal_generator_n_8,
      TO_DOMINANT => TO_DOMINANT,
      TO_DOMINANT_reg_0 => bit_count_n_23,
      TO_DOMINANT_reg_1 => bit_count_n_12,
      TO_DOMINANT_reg_2 => tq_observer_n_22,
      TO_RECESSIVE => TO_RECESSIVE,
      TO_RECESSIVE_i_2_0 => tq_observer_n_23,
      TO_RECESSIVE_i_4_0 => attack_signal_generator_n_11,
      TO_RECESSIVE_reg_0 => bit_count_n_24,
      attack_bit => attack_bit,
      attack_bit_reg_0 => attack_signal_generator_n_6,
      attack_bit_reg_1 => attack_signal_generator_n_9,
      attack_bit_reg_2 => bit_count_n_10,
      attack_state => attack_state,
      attacked_reg_0 => attack_signal_generator_n_3,
      attacked_reg_1 => msg_filter_n_5,
      attacked_reg_2 => tq_observer_n_32,
      ex_count => ex_count,
      ex_count_reg_0 => tq_observer_n_19,
      ex_resyn => ex_resyn,
      ex_resyn_reg_0 => tq_observer_n_35,
      fin_attack => fin_attack,
      in0 => in00,
      \out\ => resyn_bit,
      r_counter(5 downto 0) => r_counter(6 downto 1),
      \receiver_count_carry__0_0\(2) => tq_observer_n_24,
      \receiver_count_carry__0_0\(1) => tq_observer_n_25,
      \receiver_count_carry__0_0\(0) => tq_observer_n_26,
      resyn_bit_inferred_i_4(1 downto 0) => sender_bit(7 downto 6),
      \resyn_count_reg[2]_0\ => attack_signal_generator_n_10,
      \resyn_count_reg[7]_0\(0) => msg_filter_n_4,
      resyn_i_3_0(0) => tq_observer_n_27,
      resyn_i_4_0(0) => tq_observer_n_31
    );
bit_count: entity work.design_1_MODULE_CONTROLLER_0_0_BIT_COUNT
     port map (
      CLK => CLK,
      DEBUG => tq_observer_n_20,
      DEBUG_0 => attack_signal_generator_n_9,
      DEBUG_1 => \^debug_1\,
      ...
      \RECEIVER_BIT_reg[5]_1\ => bit_count_n_12,
      \RECEIVER_BIT_reg[7]_0\(7 downto 0) => \RECEIVER_BIT_reg__0\(7 downto 0),
      \RECEIVER_BIT_reg[7]_1\(0) => RECEIVER_BIT0,
      \SENDER_BIT_reg[2]_0\ => bit_count_n_23,
      \SENDER_BIT_reg[2]_1\ => bit_count_n_24,
      \SENDER_BIT_reg[4]_0\ => bit_count_n_25,
      ...
      TO_RECESSIVE_reg => attack_signal_generator_n_11,
      attack_bit => attack_bit,
      attack_bit_reg => bit_count_n_10,
      attack_bit_reg_0 => tq_observer_n_17,
      clear => clear,
      in0 => in00,
      r_bit_inc => r_bit_inc,
      r_bit_inc_reg_0 => bit_count_n_1,
      r_bit_inc_reg_1 => tq_observer_n_34,
      s_bit_inc => s_bit_inc,
      s_bit_inc_reg_0 => tq_observer_n_33
    );
...
state_detector: entity work.design_1_MODULE_CONTROLLER_0_0_STATE_DETECTOR
     port map (
      ...
      \S_COUNTER_reg[6]\ => tq_observer_n_7,
      ack_triger => ack_triger,
      attack_state => attack_state,
      can_signal_reg(0) => can_signal_reg(1),
      clear => clear,
...
tq_observer: entity work.design_1_MODULE_CONTROLLER_0_0_TQ_OBSERVER
     port map (
      CAN_SIGNAL_IN => CAN_SIGNAL_IN,
      CLK => CLK,
      D(2 downto 1) => sender_bit(7 downto 6),
      D(0) => sender_bit(0),
      E(0) => SENDER_BIT0,
      O(0) => receiver_count0(7),
      Q(6 downto 0) => receiver_TQ(6 downto 0),
      \RECEIVER_TQ_reg[0]_0\(0) => tq_observer_n_31,
      \RECEIVER_TQ_reg[1]_0\ => tq_observer_n_17,
      \RECEIVER_TQ_reg[1]_1\ => tq_observer_n_32,
      \RECEIVER_TQ_reg[7]_0\(2) => tq_observer_n_24,
      \RECEIVER_TQ_reg[7]_0\(1) => tq_observer_n_25,
      \RECEIVER_TQ_reg[7]_0\(0) => tq_observer_n_26,
      RESET => RESET,
      \R_COUNTER_reg[2]_0\ => communication_observation_n_3,
      \R_COUNTER_reg[3]_0\ => bit_count_n_11,
      \R_COUNTER_reg[6]_0\(5 downto 0) => r_counter(6 downto 1),
      \R_COUNTER_reg[7]_0\(0) => tq_observer_n_27,
      S(2) => tq_observer_n_28,
      S(1) => tq_observer_n_29,
      S(0) => tq_observer_n_30,
      \SENDER_TQ_reg[0]_0\ => tq_observer_n_33,
      \SENDER_TQ_reg[0]_1\ => bit_count_n_22,
      \SENDER_TQ_reg[0]_2\ => communication_observation_n_4,
      \SENDER_TQ_reg[0]_3\ => msg_filter_n_3,
      \SENDER_TQ_reg[1]_0\ => tq_observer_n_22,
      \SENDER_TQ_reg[1]_1\ => tq_observer_n_23,
      \SENDER_TQ_reg[2]_0\ => tq_observer_n_21,
      \SENDER_TQ_reg[3]_0\ => tq_observer_n_19,
      \SENDER_TQ_reg[3]_1\ => tq_observer_n_20,
      SR(0) => deviation_corrector_n_30,
      \S_COUNTER_reg[6]_0\ => state_detector_n_2,
      TO_DOMINANT_i_4 => bit_count_n_25,
      TO_RECESSIVE_i_3 => bit_count_n_26,
      ack_triger => ack_triger,
      attack_state => attack_state,
      ...
      ex_count_reg_0 => msg_filter_n_5,
      ex_resyn => ex_resyn,
      ex_resyn_reg => tq_observer_n_35,
      fin_attack => fin_attack,
      \out\ => resyn_bit,
      r_bit_inc => r_bit_inc,
      r_bit_inc_reg(0) => RECEIVER_BIT0,
      r_bit_inc_reg_0 => tq_observer_n_34,
